                    ...
                    <ul class="dropdown-menu mega-dropdown-menu row">
                        <li class="col-sm-3">
                            <ul>
                                ...
                                <!-- /.carousel -->
                                <li class="divider"></li>
                                <li><a href="#">View all products <span
